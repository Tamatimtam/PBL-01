...
// PIN INSTANCE
const uint16_t kIrLed = D6;  // AC Pin
...
const char* serverName = "http://192.168.47.146/acControl1"; // Replace with your receiving ESP IP address and endpoint
...
void ACTurnOn4() {
    ...
    HTTPClient http;
      ...
      // Start connection
    Serial.println("WIFI MESSAGE SUCCESFULLY SENT | ");
...
void setup() {
    ...
    ac.next.protocol = decode_type_t::LG;  // Set the protocol.
...
void loop() {
    ...
    static int x = 1; // Declare x as static to retain its value across iterations
    Serial.print("Attempt ");
    Serial.println(x); // Use println to move to a new line after printing x
    x += 1;
    ACTurnOn2();
    delay(300000);
